  ...
  return (
    <section id="contact" className="bg-[#0d1b2a] h-max sm:h-max flex items-center justify-center py-12 px-6">
      <div className="container mx-auto">
        <h2 className="text-4xl md:text-6xl font-bold text-center mb-12 text-yellow-200">Get in Touch</h2>
        ...
        <div className="max-w-3xl mx-auto bg-yellow-100 rounded-lg shadow-lg p-8 hover:bg-yellow-200 transform transition-transform duration-300 hover:scale-105">
          ...
          >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-8 h-8 inline-block transform hover:scale-125 transition duration-300">
