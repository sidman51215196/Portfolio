...
const IntroductionSection = () => {
  return (
    <section
      id="introduction"
      className="h-screen sm:min-h-screen flex items-center justify-center p-9 sm:p-10 bg-[#0d1b2a]"
    >
      <div className="w-max text-center bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg p-6 sm:p-10">
        <img
          src={profilePic}
          alt="Siddharth Manna"
        ...
        <p className="mt-4 text-lg sm:text-xl md:text-2xl px-4 sm:px-8 md:px-12">
          ...
          achieve new heights.
          <br />
          Whether it's coding or exploring new horizons, I'm always eager to
